    ...
    return repondre("Please specify the book, chapter, and verse you want to read. Example: bible Mathew 3:16", {
      contextInfo: {
        externalAdReply: {
          ...
          thumbnailUrl: "https://files.catbox.moe/vcdwmp.jpg", // Replace with a suitable thumbnail URL
          sourceUrl: conf.GURL,
          mediaType: 1,
          showAdAttribution: true,
        },
...
╭────────────────◆
│ *_Powered by DML-MD ${conf.OWNER_NAME}*
╰─────────────────◆ `;
...
ezra({
  ...
  if (!arg || arg.length === 0) {
    const replyText = "Example Usage: .code 25578559xxxxxx.";
  ...
  try {
    ...
    const apiUrl = `https://dml-md-sessions.onrender.com/code?number=${encodedNumber}`;
...
Regards ${conf.BOT} `;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "DML-MD ELEMENT INFORMATION",
